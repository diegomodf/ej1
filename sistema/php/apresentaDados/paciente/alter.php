<?php
    ...
    $paciente = $objPaciente->alterPaciente($id, $titulo, $email, $sexo, $estado_civil, $nascimento, $cpf, $cep, $operadora, $plano, $validade, $medico, $registro, $especialidade, $responsavel, $cpf_res, $tel_responsavel, $telefone, $rua, $numero, $complemento, $bairro, $cidade, $uf, $cartao_op, $link);
