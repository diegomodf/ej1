        ...
        <div class="box">
          <div class="box-header with-border" style="padding:15px;">
            <h3 class="box-title">Gerenciar Lotes</h3> 
              <h3 class="box-title">
                <?php
              require_once('../../../sistema/php/funcoesBd/lotes/index.php');
      ...
      <div class="row align-items-center justify-content-center">
              ...
              <table id="tabela" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align: center">Número de Lote</th>
                  <th style="text-align: center">Envio</th>
                  <th style="text-align: center">Protocolo</th>
                  <th style="text-align: center">Visualizar Lote</th>
                </tr>
                </thead>
                <tbody>
                <?php 
                    ...
                    $resultado_ids = mysqli_query($link, $sql);
                      ...
                      echo '<td>'.$registros['operadora'].'</td>';
                      echo '<td>'.$registros['lote'].'</td>';
                      echo '<td>'.$registros['enviado'].'</td>';
                      echo '<td>'.$registros['protocolo'].'</td>';?>
                      <td><a href="visualizar.php?lote=<?php echo $registros['lote']?>">Clique Aqui</a></td>
                      <?php 
                      echo '</tr>';
