    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <h5 class="box-title">Cadastrar nova senha</h5>
              <!-- /.box-tools -->
            </div> 
            <!-- /.box-header -->
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <h5>Senha anterior</h5>
                      <input type="password" name= "nome" class="form-control" placeholder="Senha anterior" required>
                  </div>
                  <div class="form-group col-lg-4">
                  <h5>Nova senha</h5>
                      <input type="password" name= "nome" class="form-control" placeholder="Nova senha" required>
                  </div>
                  <div class="form-group col-lg-4">
                  <h5>Confirma nova senha</h5>
                      <input type="password" name= "nome" class="form-control" placeholder="Nova senha" required>
                  </div>
                </div>
              ...
              <div class="modal-footer">
                  <a href="../../usuarios/funcionarios/index.php">
                    ...
                    <input type="submit" class="btn btn-primary" value="Cadastrar Nova Senha" name="submit">
                </div>
              </div>
