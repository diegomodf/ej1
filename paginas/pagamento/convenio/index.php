            ...
            <h3 class="box-title">Particular</h3>  
              ...
              <table id="tabela" class="table table-bordered table-striped">
                ...
                <?php 
                    ...
                    $sql = " SELECT * FROM paciente WHERE operadora != 'PARTICULAR'";
                    $resultado_ids = mysqli_query($link, $sql);
                      if($resultado_ids){
                          ...
                          echo '<td><a href="consultas.php?id='.$id.'"><button class="fa fa-edit item_lista" class="btn btn_success" type="button"></button></a></td>';
                          echo '</tr>';
                        }                      
                      }else{
